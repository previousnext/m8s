...
func Create(client *kubernetes.Clientset, namespace, image, version string) error {
...
func createSecret(client *kubernetes.Clientset, namespace string) (*v1.Secret, error) {
	secret := &v1.Secret{
...
func createDeployment(client *kubernetes.Clientset, namespace, image, version string, replicas, history int32) (*v1beta1.Deployment, error) {
...
func createService(client *kubernetes.Clientset, namespace string) (*v1.Service, error) {
