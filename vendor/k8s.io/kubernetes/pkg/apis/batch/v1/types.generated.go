...
func (x *JobSpec) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[2] = x.FailureThreshold != nil
			yyq2[3] = x.ActiveDeadlineSeconds != nil
			yyq2[4] = x.Selector != nil
			yyq2[5] = x.ManualSelector != nil
			var yynn2 int
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem1234)
				if yyq2[2] {
					if x.FailureThreshold == nil {
						r.EncodeNil()
					} else {
						yy14 := *x.FailureThreshold
						yym15 := z.EncBinary()
						_ = yym15
						if false {
						} else {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "failureThreshold":
			if r.TryDecodeAsNil() {
				...
				if x.FailureThreshold == nil {
					x.FailureThreshold = new(int32)
				}
				yym9 := z.DecBinary()
				_ = yym9
				if false {
				} else {
					*((*int32)(x.FailureThreshold)) = int32(r.DecodeInt(32))
				}
			}
